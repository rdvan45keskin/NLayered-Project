...
namespace Northwind.Business.ValidationRules.FluentValidation
{
    public class ProductValidator:AbstractValidator<Product>
    {
        ...
        public ProductValidator()
        {
            ...
            RuleFor(p => p.CategoryId).NotEmpty().WithMessage("Kategori idsi boş olamaz"); ;
            RuleFor(p => p.QuantityPerUnit).NotEmpty().WithMessage("Ürün miktarı boş olamaz"); ;
